...
class CertificateValidator {
    ...
    {
        // setting the required http status code 400 for certificate error
        // (we will set back to 200 after all certification checks are concluded with success)
    ...
    public function validateCertificate()
    {
        ...
        if ($parsedCertificate == null ||
            ...
            throw new InvalidArgumentException("The remote certificate doesn't contain a valid SAN in the signature or is expired or was not found.");
        }
    }
    ...
    public function fetchCertificate()
    {
        if (!function_exists("curl_init")) {
            throw new RuntimeException('CURL is required to download the Signature Certificate.');
        }
        $ch = curl_init();
