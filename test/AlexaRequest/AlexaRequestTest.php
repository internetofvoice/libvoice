...
use InternetOfVoice\LibVoice\AlexaRequest\AlexaRequest;
...
class AlexaRequestTest extends TestCase {
	...
	public function testIntentRequest() {
		...
		$this->assertEquals('InternetOfVoice\LibVoice\AlexaRequest\Application', get_class($alexaRequest->getApplication()));
		$this->assertStringStartsWith('amzn1.ask.skill.', $alexaRequest->getApplication()->getApplicationId());
		$this->assertEquals('InternetOfVoice\LibVoice\AlexaRequest\User', get_class($alexaRequest->getUser()));
